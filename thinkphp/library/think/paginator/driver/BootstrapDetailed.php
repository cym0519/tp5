...
Class BootstrapDetailed extends Paginator {
    ...
    {
        return $gotohtml="<li style='float: left'><form action='' method='get' ><a style='float:left;margin-left:2px;'><input style='height:33px; type='text' name='page' placeholder='请选择页数'> <input style='height:33px;' type='submit' value='确定'> </a></form></li>";
        // return $totalhtml;;
