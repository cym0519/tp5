...
class WxPayConfig extends WxPayConfigInterface
{
	 ...
	 * 
	 */
    const APPID = 'wx426b3015555a46be';//测试appid
    const APPSECRET = '01c6d59a3f9024db6336662ac95c8e74';//测试appsecret
    const MCHID = '1225312702';//测试商户号
    const KEY = 'e10adc3949ba59abbe56e057f20f883e';//测试支付密钥
